...
//
//public class backup3 implements RecipeBuilder {
...
//
//    public backup3(ItemLike left_slot, ItemLike middle_slot, ItemLike right_slot, ItemLike result, int count) {
...
//
//        public Result(ResourceLocation pId, Item pResult, int pCount, Ingredient left_slot, Ingredient denim, Ingredient embroidery, Advancement.Builder pAdvancement, ResourceLocation pAdvancementId) {
//            this.id = pId;
//            this.result = pResult;
//            this.left_slot = left_slot;
//            this.middle_slot = denim;
//            this.right_slot = embroidery;
//            this.count = pCount;

...
import net.thekingskull01.tsotd.worldgen.ModBiomeModifers;
import net.thekingskull01.tsotd.worldgen.ModConfiguredFeatures;
import net.thekingskull01.tsotd.worldgen.ModPlacedFeatures;
...
public class ModWorldGenProvider extends DatapackBuiltinEntriesProvider {
    ...
    public ModWorldGenProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, BUILDER, Set.of(TSOTD.MOD_ID));
    }
}

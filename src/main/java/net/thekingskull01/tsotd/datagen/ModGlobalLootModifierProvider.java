...
public class ModGlobalLootModifierProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        //add("lifestealer_enchantment_from_desert_temple", new AddItemModifer(new LootItemCondition[] {
        //         new LootTableIdCondition.Builder(new ResourceLocation("chests/desert_temple")).build(),
        //        LootItemRandomChanceCondition.randomChance(1f).build()}, Life_Stealer().getItem()));
    ...
    //private static ItemStack Life_Stealer() {
    //    ItemStack LifeStealer = new ItemStack(Items.ENCHANTED_BOOK);
    //    ModEnchantments.LIFE_STEALER.get();
    //    return LifeStealer;
    //}
}

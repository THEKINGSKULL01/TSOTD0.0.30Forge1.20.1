...
public class TakichirumCreationRecipe implements Recipe<SimpleContainer> {
    ...
    public TakichirumCreationRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> inputItems) {
    ...
    public static class Serializer implements RecipeSerializer<TakichirumCreationRecipe> {
        ...
        public TakichirumCreationRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new TakichirumCreationRecipe(id, output, inputs);
        }

        @Override
        public TakichirumCreationRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {

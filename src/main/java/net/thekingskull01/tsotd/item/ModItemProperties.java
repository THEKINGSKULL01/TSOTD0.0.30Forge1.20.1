...
public class ModItemProperties {
    public static void  addCustomItemProperties() {
        ...
        makBow(ModItems.Dark_Crystal_Bow.get());
        makBow(ModItems.Light_Crystal_Bow.get());

        ItemProperties.register(ModItems.Takichirum_Shield.get(), new ResourceLocation("blocking"), (p_174575_, p_174576_, p_174577_, p_174578_) -> {
            return p_174577_ != null && p_174577_.isUsingItem() && p_174577_.getUseItem() == p_174575_ ? 1.0F : 0.0F;
        });
    }

    private static void makBow(Item item) {

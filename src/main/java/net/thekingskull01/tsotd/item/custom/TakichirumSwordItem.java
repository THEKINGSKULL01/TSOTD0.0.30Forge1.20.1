...
public class TakichirumSwordItem extends SwordItem {
    public TakichirumSwordItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
